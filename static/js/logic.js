...
function addFeatures(bigEdata) {
    function eaFeat(feature, layer) {
    ...
    // GeoJson layer containing the feautures array on bigEdata object
    var earthquakes = L.geoJSON(bigEdata, {
